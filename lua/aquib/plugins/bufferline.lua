return {
  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd("TabClosed", { callback = function() cache[last_tab] = nil end })
    vim.api.nvim_create_autocmd("TabNewEntered", { callback = function() vim.api.nvim_buf_set_option(0, "buflisted", true) end })
